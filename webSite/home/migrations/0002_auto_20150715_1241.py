    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulte_mise_en_place', models.ForeignKey(to='home.DifficulteReco')),
                ('echeance', models.ForeignKey(to='home.EcheanceReco')),
            ],
        ),
        migrations.CreateModel(
            name='Vulnerabilite',
            fields=[
                ...
                ('difficulte_exploit', models.ForeignKey(to='home.DifficulteExploitVuln')),
                ('impact', models.ForeignKey(to='home.ImpactVuln')),
                ('rapport_associe', models.OneToOneField(to='home.Rapport')),
            ],
        ),
        migrations.AddField(
            model_name='recommandation',
            name='vuln',
            field=models.ForeignKey(to='home.Vulnerabilite'),
        ),
        migrations.AddField(
            model_name='motclef',
            name='vuln',
